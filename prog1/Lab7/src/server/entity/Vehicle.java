...
public class Vehicle implements Serializable{
     ...
     */
    public Vehicle(int id, String name, Coordinates coordinates, java.time.LocalDateTime creationDate, Long enginePower, float fuelConsumption, long distanceTravelled, VehicleType type, String login) {
        setId(id);
        setName(name);
     ...
     * @throws IllegalArgumentException если данные не соответствуют ограничениям
     */
    public Vehicle(String name, Coordinates coordinates, java.time.LocalDateTime creationDate, Long enginePower, float fuelConsumption, long distanceTravelled, VehicleType type, String login) {
